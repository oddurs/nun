...
with its id: `feat/0007-core-buffer` for a migrated item, which keeps its
number, or the first eight hex digits of the `id` for one created since
(`feat/3f9c2a1b-core-buffer`).
...
- **Milestones**: `m1` (due 2026-09-24), `m2` (due 2026-10-08), `m3` (due 2026-10-29), `m4` (due 2026-11-19), `m5` (due 2026-12-03), `perf` (due 2026-12-10), `m6` (due 2026-12-17)
